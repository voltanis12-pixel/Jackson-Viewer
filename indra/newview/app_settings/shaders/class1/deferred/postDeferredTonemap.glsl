...
//
// Adds a tiny sub-pixel noise signal before the final 0-1 clamp
// to reduce visible 8-bit banding in skies, fog, shadows, and
// other smooth gradients.
//
// The amplitude is one 8-bit code value at maximum and averages
// to zero, so overall brightness and color balance are preserved.
//===============================================================
